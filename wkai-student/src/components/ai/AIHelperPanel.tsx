    ...
    <div className="grid h-full grid-cols-1 lg:grid-cols-3">
      <div className="lg:col-span-2 border-r border-wkai-border min-h-0 flex flex-col">
        <div className="border-b border-wkai-border px-4 py-2 bg-wkai-surface">
          <p className="text-xs font-semibold uppercase tracking-widest text-teal-400 flex items-center gap-2">
            <Bot size={12} />
            AI Helper Workspace
          </p>
        ...
        <div className="border-b border-wkai-border min-h-0">
          <div className="flex h-full flex-col">
            <div className="flex border-b border-wkai-border">
              <button
                className={`flex-1 py-2 text-xs font-medium ${assistTab === "error" ? "text-teal-400 border-b-2 border-teal-400" : "text-wkai-text-dim"}`}
                onClick={() => setAssistTab("error")}
              >
                Error Helper
              </button>
              <button
                className={`flex-1 py-2 text-xs font-medium ${assistTab === "colab" ? "text-teal-400 border-b-2 border-teal-400" : "text-wkai-text-dim"}`}
