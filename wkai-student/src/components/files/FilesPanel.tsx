...
function FileRow({ file }: { file: import("../../types").SharedFile }) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-wkai-border bg-wkai-surface px-4 py-3 group hover:border-teal-500/40 transition-colors">
      ...
      <a
        ...
        className="flex items-center gap-1.5 rounded-lg border border-wkai-border px-3 py-1.5 text-xs text-wkai-text-dim
          hover:border-teal-500/50 hover:text-teal-400 transition-all opacity-0 group-hover:opacity-100"
      >
        <Download size={12} />
        Download
      </a>
